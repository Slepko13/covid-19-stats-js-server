//! All country names with ISO code

//? This is hardcoded list of the countries. Change it from "country_list_no_db" to "country_list" and use when database is not available
let country_list_no_db = [
    { name: 'USA', code: 'US' },
    { name: 'Spain', code: 'ES' },
    { name: 'Italy', code: 'IT' },
    { name: 'France', code: 'FR' },
